  ...
  return {
    acquire() {
      ...
      if (!renderer) {
        ...
        renderer.domElement.addEventListener('webglcontextlost',()=>{broken=true;},{once:true});
      ...
      return { renderer, environment, release() { if(released)return;released=true;users--;if(disposeRequested)destroy(); } };
    },
